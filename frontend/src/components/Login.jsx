	...
	return (
		...
		<p className="text-red-500 font-bold text-4xl p-5">LOGO HERE</p>
			...
			<div className="bg-red-200 max-w-[940px]  h-[623px] rounded-3xl border-4 border-green-900 mx-auto shadow-xl scale-75 p-[80px]">
				...
				<div className="bg-purple-50 border-4 border-blue-900 rounded-3xl max-w-[330px] mx-auto my-5 p-10">
					<input
					...
					/>
					<button className="bg-black-300 ml-12 rounded-lg m-3 p-3 font-bold" onClick={login}>
						LOGIN
					</button>
					<br />
