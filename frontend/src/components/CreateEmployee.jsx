...
const CreateEmployee = () => {
	...
	return (
		...
		<p className="bg-yellow-200 text-red-500 text-center font-bold text-4xl p-5">Create Employee</p>
			...
			<div className="bg-orange-50 border-4 border-blue-900 rounded-3xl max-w-[350px] mx-auto my-5 p-10">
				<input
				...
				{/* Gender radio button */}
				<label htmlFor="" className="m-1 text-black-600"><b>Gender</b></label>
				<input
					type="radio"
					id="male"
					name="gender"
				...
				{/* Courses check boxes */}
				<label className="m-1 text-black-600"><b>Course</b></label>
				<input
					type="checkbox"
					id="MCA"
					name="course"
				...
				<button className="bg-red-300 ml-12 rounded-lg m-3 p-3 font-bold" onClick={formHandle}>
					Register Me
				</button>
			</div>
		</div>
